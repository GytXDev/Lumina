...
class CarsModel {
  ...
  String currency;
  final bool isPayed;
  final bool isCertified; // Ajout de la propriété isCertified
  ...
  CarsModel({
    ...
    this.currency = '',
    this.isPayed = false,
    this.isCertified = false, // Valeur par défaut pour isCertified
  });
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      'currency': currency,
      'isPayed': isPayed,
      'isCertified': isCertified, // Ajout de isCertified dans le map
    };
  }
  ...
  factory CarsModel.fromMap(Map<String, dynamic> map, String id) {
    ...
    return CarsModel(
      ...
      isCertified: map['isCertified'] ?? false, // Extraction de isCertified
    );
  }
}
