...
import 'package:lumina/features/cars/pages/car_edit.dart';
        ...
        actions: [
          ...
          FutureBuilder<User?>(
            ...
            builder: (context, snapshot) {
              ...
              if (snapshot.hasData &&
                  (snapshot.data!.uid == widget.userId ||
                      snapshot.data! == "admin")) {
                return IconButton(
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => CarEditPage(
                          ...
                          carName: widget.carName,
                          brand: widget.carModel,
                          yearOrNew: widget.carType != null
                              ? widget.carType!
                              : CarType.news,
                          imageUrls: widget.carImageURLs,
                          price: widget.carPrice,
                          description: widget.carDescription,
                          duration: widget.carDuration,
                          userId: widget.userId,
                        ),
                      ),
